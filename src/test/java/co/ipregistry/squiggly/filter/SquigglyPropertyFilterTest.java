package co.ipregistry.squiggly.filter;
...
import co.ipregistry.squiggly.context.provider.SimpleSquigglyContextProvider;
import co.ipregistry.squiggly.model.*;
import co.ipregistry.squiggly.parser.SquigglyParser;
import co.ipregistry.squiggly.util.SquigglyUtils;
...
public class SquigglyPropertyFilterTest {
    ...
    public static final String BASE_PATH = "co/ipregistry/squiggly/SquigglyPropertyFilterTest";
    private Issue issue;
