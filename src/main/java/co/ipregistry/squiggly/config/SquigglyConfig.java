package co.ipregistry.squiggly.config;
...
public class SquigglyConfig {
     ...
     * @see co.ipregistry.squiggly.view.PropertyView
     */
     ...
     *
     * @return spec
     * @see co.ipregistry.squiggly.filter.SquigglyPropertyFilter
     */
     ...
     *
     * @return spec
     * @see co.ipregistry.squiggly.parser.SquigglyParser
     */
