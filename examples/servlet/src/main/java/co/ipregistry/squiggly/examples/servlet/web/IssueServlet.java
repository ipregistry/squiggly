package co.ipregistry.squiggly.examples.servlet.web;

import co.ipregistry.squiggly.examples.servlet.model.Issue;
import co.ipregistry.squiggly.examples.servlet.util.Jackson;
